...
function openapiSpec() {
  ...
  return {
    ...
    info: {
      ...
      version: VERSION,
      description: "Ethical pre-execution filter. Sequential PASS/REVISE/BLOCK. wrap (shell exec) is not hosted. " + MOTTO + " Suite mesh /v1/mesh/* PROXY to aziel-runtime (AZIEL_RUNTIME). Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 hub cite (photon QNS1 packet transfer). No Node Gate. No public qnsd proxy. No auto-heal. Not anonymity. Aziel Eliab only.",
    },
    servers: [{ url: HOST }],
    paths: {
      "/count": {
...
<title>DecisionGATE — use with AI assistants</title>
<style>
...
<body>
  ...
  <p>Author: Aziel Eliab. This Worker is a sequential five-gate filter. It does <strong>not</strong> run commands. There is no hosted <code>wrap</code>.</p>
  <h2>AI assistants</h2>
  ...
  <h2>OpenAPI</h2>
  <p>Import this OpenAPI URL as a GPT Action, custom HTTP tool, xAI custom tool, or any other OpenAPI importer:</p>
  ...
  <p>Suite mesh: <code>GET ${HOST}/v1/mesh</code> PROXY to aziel-runtime. Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 hub cite (photon QNS1 packet transfer). No Node Gate. No public qnsd proxy. No auto-heal. Not anonymity. Author: Aziel Eliab only.</p>
