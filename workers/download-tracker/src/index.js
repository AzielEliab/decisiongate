...
<body>
  <h1>DecisionGATE</h1>
  <p class="motto">Freedom without clarity is chaos.</p>
  <div class="card">
    <p class="count">${n}<span> downloads of this project</span></p>
    <a class="dl" href="/download?asset=decisiongate-0.1.0.tar.gz">Download decisiongate-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>decisiongate-download-tracker</code>, project <code>decisiongate</code>. Not mixed with any other product.</p>
...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === "/go" && request.method === "GET") {
      ...
      const asset = dims.asset || "decisiongate-0.1.0.tar.gz";
